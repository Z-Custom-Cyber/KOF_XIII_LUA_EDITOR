...
#define DEVICE_NS			2
	...
	#define MSG_DEVICE_CODE_ERROR  "error: 非法的设备编号"
	...
	#define MSG_DEVICE_REQUEST       "请输入设备编号: "
	#define MSG_OPERATION_REQUEST    "请输入操作编号: "
	#define MSG_INPUT                "目标文件: "
	#define MSG_OUTPUT               "输出文件: "
#endif
#ifdef LANGUAGE_EN
	#define START_SYMBOL "---- START -----------------------------------------------------\n"
	#define DEVICE_NAME "select device:\n    [1]:PC\n    [2]:NS\n    [0]:Exit\n"
	...
	#define MSG_DEVICE_CODE_ERROR  "error: valid_device_code"
	...
	#define MSG_DEVICE_REQUEST       "input device code: "
	#define MSG_OPERATION_REQUEST    "input operation code: "
